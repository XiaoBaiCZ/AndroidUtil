...
public final class SystemUiHelper {
     ...
     * 还原初始状态
     */
    public SystemUiHelper revert() {
        if (!checkSafe()) {
            return this;
        }
        mSystemUiAction.revert(getWindow());
        return this;
    }
    ...
    public SystemUiHelper setLightStatusBar() {
        ...
        mSystemUiAction.setLightStatusBar(getWindow());
        return this;
    }
    ...
    public SystemUiHelper setLightNavigationBar() {
        ...
        mSystemUiAction.setLightNavigationBar(getWindow());
        return this;
    }
